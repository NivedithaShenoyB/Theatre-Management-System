...
<div class="art-header">
        <div class="art-header-position">
            <div class="art-header-wrapper">
                ...
                <div class="art-logo">
                                 <h1 class="art-logo-name"><a href="#">Seat Selection</a></h1>
...
<div style="width:540px; margin: 0 auto;">
 ...
 <?php 
	...
	$result=mysqli_query($con,"SELECT seatno FROM tickets,shows WHERE show_id=".$sid.";");



 $seats=array_fill(1,35,'empty');
